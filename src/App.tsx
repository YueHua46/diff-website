...
function App() {
  ...
  return (
    <>
      {/* 可拖动区域 */}
      <header className='text-center flex items-center justify-center fixed top-0 left-0 right-0 h-10 bg-gray-100 -webkit-app-region: drag z-50 select-none'>
        <h1 className='m-0 p-0 c-gray-800 text-xl'>Diff Website</h1>
      </header>
      <div className="min-h-screen min-w-screen box-border bg-gray-100 p-2 sm:p-4 md:p-6" style={{ minWidth: 'calc(100vw - 15px)' }}>
        <Toast
          show={toast.show}
